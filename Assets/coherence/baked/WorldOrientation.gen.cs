...
namespace Coherence.Generated
{
	...
	public struct WorldOrientation : ICoherenceComponentData
	{
		...
		public static (WorldOrientation, uint, uint?) DeserializeArchetypeCube_6205896415a6a2640b6e4489bce936a2_WorldOrientation_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new WorldOrientation();
			if (bitStream.ReadMask())
